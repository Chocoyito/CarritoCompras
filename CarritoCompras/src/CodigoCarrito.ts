...
// Variables
const carrito: any = document.querySelector(`#carrito`);
const contenedorCarrito: any = document.querySelector(`#lista-carrito tbody`);
const limpiarCarrito: any = document.querySelector(`#vaciar-carrito`);
const listaCursos: any = document.querySelector(`#lista-cursos`);
