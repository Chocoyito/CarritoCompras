...
const precioMinimo: any = document.querySelector(`#minimo`);
const precioMaximo: any = document.querySelector(`#maximo`);
const puertas: any = document.querySelector(`#puertas`);
const transmision: any = document.querySelector(`#transmision`);
...
function mostrarAutos(autos: any): void
{
    ...
    autos.forEach((auto: { marca: string; modelo: string; year: number; puertas: number; transmision: string; precio: number; color: string; }) => 
    {
        ...
        const autoHTML: any = document.createElement(`p`);
